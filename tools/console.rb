...
painting1 = Painting.new("Mona Lisa", 99999, artist1, gallery1) 
painting2 = Painting.new("El Salvador", 2, artist2, gallery1)
painting3 = Painting.new("Water Serpent", 50000, artist3, gallery1)
painting4 = Painting.new("Starry Night", 5, artist4, gallery1)
